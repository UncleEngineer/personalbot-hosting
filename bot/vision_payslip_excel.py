...
#     # monthly_expense = df.groupby(pd.to_datetime(df['Date']).dt.to_period('M'))['Expense'].sum()
...
#     return daily_expense_str, monthly_expense_str
...
if __name__ == "__main__":
    ...
    image_path = '/home/moomer/DevStuffs/line-api/bot-modes/payslip-ocr-mode/slips-dataset/slip2.png'
    result = get_text_from_payslip(image_path)
    # result = get_text_from_payslip(image_url="https://18pee.com/wp-content/uploads/2022/01/g-wallet-slip.jpg")
    # print(result)
